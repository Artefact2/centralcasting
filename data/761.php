...
Table($s, "761A", "Who is the companion?", Roll(100), [
	...
	"12-22" => [ "Family member", function() use(&$s) { Invoke($s, "753"); } ],
	"23-33" => [ "Nonhuman", function() use(&$s) { Invoke($s, "751"); } ],
	"34-44" => [ "Stranger", function() use(&$s) { /* XXX 750 */ } ],
	...
	"78-88" => [ "Adventurer", function() use(&$s) { /* XXX 757 */ } ],
	"89-99" => [ "Former enemy or rival", function() use(&$s) { /* XXX 758 */ } ],
...
Table($s, "761B", "Why become a companion?", Roll(10), [
	...
	"4" => [ "Share the same enemy", function() use(&$s) { /* XXX 762 */ }],
